...
//CODE HERE
function compareNums(var1, var2) {
  if (var1 > var2) {
    return var1;
  } else {
    return var2;
...
let nameGreeting = nameCheck('Owen')
...
console.log(bestMovie('Wolf of Wallstreet'))
...
console.log(emailCheck('owenclary@gmail.com'))
...
let bathtubScope = ['cute', 'squeaky', 'nuatical']
